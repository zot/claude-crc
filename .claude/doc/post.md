...
The AI "generously" inferred things from my specs that weren't actually in there. I wasn't as diligent as I should have been with reviewing the generated code -- because AI, I suppose. It generates so much code so fast that eventually it becomes easier just to have it auto-approve already. AI can give you a lot more than you asked for. It's great! But then I changed a spec, Claude changed code in response to that, and it decided to remove one of the generous additions I hadn't asked for. Only I had come to think of that as part of my app.
...
What I wanted was a middle level where I could see how Claude was interpreting my specs but that wasn't reams and reams of code. I looked at some spec-driven development packages and read  [What You See Is What It Does paper](https://arxiv.org/abs/2508.14511), by Meng and Jackson at MIT. It's a good paper with clear benefits but I didn't like their "dumb data" / "procedural database code" model. I realized that I had used a system much like theirs for decades but for human development, not AI development.
...
I realized with AI as the developer I am now the customer. 😮

## CRC Spec-Driven Development

Spec languages are not new -- they've been around since the late 70s. CRC cards were created by Ward Cunningham (inventor of the Wiki) and Kent Beck in the early-mid 80s for Smalltalk teaching and brain storming -- at the dawn of agile development.
...
A great way to start out is to ask Claude for help like, "I want to make a contact management app. Put some specs for it that I can use with the designer agent."
